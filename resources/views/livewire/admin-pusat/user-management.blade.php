<div>
    ...
    <x-slot name="header">
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            {{-- Tombol Tambah Pengguna sudah dipindahkan ke bawah sesuai file Anda --}}
        </div>
    </x-slot>
    ...
    <div class="py-6">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg">
                <div class="p-4 sm:p-6">
                    ...
                    <div class="mb-6 grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
                        ...
                        <div>
                            <label for="filterRole" class="block text-sm font-medium text-gray-700">Filter Berdasarkan Peran</label>
            ...
            {{-- Akhir Tabel dan Konten Lainnya --}}

            {{-- Modal Tambah/Edit Pengguna --}}
            @if ($showUserModal)
                {{-- ... (Kode Modal Anda tidak berubah, pastikan z-index modal adalah z-50 atau lebih tinggi) ... --}}
