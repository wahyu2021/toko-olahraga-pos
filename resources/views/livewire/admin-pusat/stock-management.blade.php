<div>
    ...
    <div class="py-6">
        <div class="max-w-full mx-auto sm:px-6 lg:px-8">
                                ...
                                @forelse ($stocksView as $stock)
                                    <tr>
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500 font-semibold">
                                            {{ $stock->quantity }}</td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                                            {{ $stock->last_restock_date ? \Carbon\Carbon::parse($stock->last_restock_date)->isoFormat('D MMM YYYY') : '-' }}
                                        </td>
                                        <td
                                            class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                            <button
                                                wire:click="openStockModal({{ $stock->product_id }}, {{ $stock->branch_id }})"
                                                class="text-blue-600 hover:text-blue-900">Sesuaikan</button>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                ...
                                <div class="mt-4 space-y-4">
                                    <div>
                                        ...
                                        <select wire:model.live="product_id" id="modal-product_id"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('product_id') border-red-500 @enderror"
                                    ...
                                    <div>
                                        ...
                                        <select wire:model.live="branch_id" id="modal-branch_id"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('branch_id') border-red-500 @enderror"
                                            {{ $stock_id || ($product_id && $branch_id) ? 'disabled' : '' }}>
                                    ...
                                    <div>
                                        ...
                                        <input wire:model.defer="quantity" type="number" id="modal-quantity"
                                            ...
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('quantity') border-red-500 @enderror">
                                        @error('quantity')
                                            <span class="text-red-500 text-xs">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select wire:model.defer="movement_type" id="modal-movement_type"
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('movement_type') border-red-500 @enderror">
                                            ...
                                            {{-- <option value="adjustment_increase">Penambahan (Adjustment Increase)</option> --}}
                                            {{-- <option value="adjustment_decrease">Pengurangan (Adjustment Decrease)</option> --}}
                                            {{-- Bisa ditambahkan tipe lain jika ada pembelian langsung dari sini --}}
                                        </select>
                                        @error('movement_type')
                                            <span class="text-red-500 text-xs">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div>
                                        ...
                                        <textarea wire:model.defer="notes" id="modal-notes" rows="3"
                                            ...
                                            class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm @error('notes') border-red-500 @enderror"></textarea>
                                        @error('notes')
                                            <span class="text-red-500 text-xs">{{ $message }}</span>
                                        @enderror
                                    </div>
            ...
            @endif
            {{-- Tidak ada modal delete untuk stok --}}
        </div>
    </div>
</div>
